...
SECRET_KEY = 'lvbj0ep($qu0(5r!i66nlx^h^ds5jq)a_folm*4nu2k1k_qs*z'
...
ROOT_URLCONF = 'full_user_authentication.urls'
...
WSGI_APPLICATION = 'full_user_authentication.wsgi.application'
